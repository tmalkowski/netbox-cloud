...
class Application(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_cloud:application", kwargs={"pk": self.pk})
...
class IC(NetBoxModel):
    ...
    def get_absolute_url(self):
        url = reverse("plugins:netbox_cloud:service", kwargs={"pk": self.service.pk})
        try:
...
class Relation(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_cloud:relation", kwargs={"pk": self.pk})
